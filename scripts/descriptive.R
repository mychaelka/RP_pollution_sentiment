...
cnty_aggr <- full_data %>% 
  ...
  summarize(pm25=median(pm25),
            ...
            wind_strength=median(wind_strength))
...
summary(cnty_aggr$wind_strength)
sd(cnty_aggr$wind_strength, na.rm=TRUE)
...
ggsave(filename = "../figs/paper/weekdays_sentiment.png", plot=last_plot(), 
       width = 12, 
       height = 7, bg = "white")
