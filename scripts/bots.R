...
# Commented lines of code below calculate numbers of users that tweeted more than
# x times during y seconds. Used as a metric to detects spam bots. Based on the results
# we decided that 5-5 was a suitable threshold.

# Define time windows in seconds and thresholds for tweet counts
#time_windows <- c(2, 5, 10)
